...
ALTER TABLE "billing_months" ADD CONSTRAINT IF NOT EXISTS "billing_months_user_id_fkey"
  FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- Align FileObject ownerId with integer user IDs
ALTER TABLE "FileObject"
  ALTER COLUMN "ownerId" TYPE INTEGER USING "ownerId"::integer;

ALTER TABLE "FileObject" DROP CONSTRAINT IF EXISTS "FileObject_ownerId_fkey";
ALTER TABLE "FileObject" ADD CONSTRAINT "FileObject_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
